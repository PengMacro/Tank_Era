...
#define				CHAR_COLUMNS		(COLS/FONT_WIDTH)		// number of characters that fit across screen (21)
#define				CHAR_ROWS				(ROWS/FONT_HEIGHT)	// number of lines of text that fit on screen (20)
#define				X_PADDING       ((COLS % FONT_WIDTH)/2) (9/2=4)
